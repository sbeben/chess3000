...
interface ChessboardProviderContext {
  ...
  customDraggingPieceStyle: RequiredChessboardProps["customDraggingPieceStyle"];
  // Exported by context
  arrows: Arrow[];
...
export const ChessboardProvider = forwardRef(
  (
    ...
    function handleSetPosition(sourceSq: Square, targetSq: Square, piece: Piece, wasManualDropOverride?: boolean) {
    ...
    return <ChessboardContext.Provider value={ChessboardProviderContextValue}>{children}</ChessboardContext.Provider>;
  },
);
