...
export function CustomDragLayer({ boardContainer }: CustomDragLayerProps) {
  const { boardWidth, chessPieces, id, snapToCursor, allowDragOutsideBoard, customDraggingPieceStyle } =
    useChessboard();
    ...
    >
      <div style={getItemStyle(clientOffset, sourceClientOffset)}>
        {typeof chessPieces[item.piece] === "function" ? (
          ...
          <svg viewBox={"1 1 43 43"} width={boardWidth / 8} height={boardWidth / 8} style={customDraggingPieceStyle}>
